...
Thanks for your interest in contributing to `commit-to-co-authors`! 💖
...
Check [previously merged PRs](https://github.com/JoshuaKGoldberg/commit-to-co-authors/pulls?q=is%3Apr+is%3Amerged+-label%3Adependencies+) for reference.
